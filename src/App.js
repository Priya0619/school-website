        ...
        <div className="main-container">
            ...
            <section className='contact'>
                ...
                <form id="form">
                    ...
                    <input className="form-input" type="text" name="fullname" id="fullname" /><br />
                    <label className='input-text' htmlFor="address">Address </label>
                    <input className="form-input" type="text" name="address" id="address" /><br />
                    <label className='input-text' htmlFor="contact">Contact Number</label>
                    <input className="form-input" type="number" name="contact" id="contact" /><br />
                    <label className='input-text' htmlFor="email"> Email Address</label>
                    <input className="form-input" type="email" name="email" id="email" /><br />
                    <label className='input-text' htmlFor="message"> Message</label>
                    <textarea className="form-input" name="message" id="message"  ></textarea>  <br />
